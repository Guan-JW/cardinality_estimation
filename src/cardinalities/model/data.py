...
# 定义 num_materialized samples = 1000
...
def load_and_encode_train_data(num_queries, num_materialized_samples):
    ...
    joins, predicates, tables, label = load_data(file_name_queries, num_materialized_samples)
...
def get_train_datasets(num_queries, num_materialized_samples):
    dicts, column_min_max_vals, min_val, max_val, labels_train, labels_test, max_num_joins, max_num_predicates, \
    train_data, test_data = load_and_encode_train_data(num_queries, num_materialized_samples)
