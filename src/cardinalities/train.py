...
def train_and_predict(workload_name, num_queries, num_epochs, batch_size, hid_units, cuda):
    ...
    train_data, test_data = get_train_datasets(num_queries, num_materialized_samples)
...
def main():
    ...
    train_and_predict('synthetic', args.queries, args.epochs, args.batch, args.hid, args.cuda)
